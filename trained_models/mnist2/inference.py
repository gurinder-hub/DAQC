...
def run_noisy_inference_for_tq_circuits_qiskit(circ_dir, num_qubits, meas_qubits, device_name,
    ...
    mnist_test = MNIST(root = "./mnistdata1_test", train = False, download = True)
...
num_shots = 10000
best_t = 0.29
circs_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/mnist2/trained_circuit/'
num_test_samples = 2115
transpiler_opt_level = 3
results_save_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/mnist2/trained_circuit/inference_sim'
