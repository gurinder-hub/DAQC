...
def run_noisy_inference_for_tq_circuits_qiskit(circ_dir, num_qubits, meas_qubits, device_name,
    ...
    test_ds = AugmentedZigzagDataset(npz_path="/home/singhg12/isilon/Gurinder/Benchmark_medmnist/Pneumonia_mnist_28/pneumoniamnist.npz", split="test")
    test_loader =  torch.utils.data.DataLoader(test_ds, batch_size=len(test_ds), sampler=torch.utils.data.SequentialSampler(test_ds))
...
num_shots = 10000
best_t = 0.7
circs_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/pneumonia2/trained_circuit/'
num_test_samples = 624
transpiler_opt_level = 3
results_save_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/pneumonia2/trained_circuit/inference_sim'
