...
def run_noisy_inference_for_tq_circuits_qiskit(circ_dir, num_qubits, meas_qubits, device_name,
    ...
    fmnist_test = FashionMNIST(root = "./fmnistdata_test1", train = False, download = True)
...
num_shots = 10000
best_t = 0.5
circs_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/fmnist10/trained_circuit/'
num_test_samples = 10000
transpiler_opt_level = 3
results_save_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/fmnist10/trained_circuit/inference_sim'
