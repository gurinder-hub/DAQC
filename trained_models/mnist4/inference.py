...
def run_noisy_inference_for_tq_circuits_qiskit(circ_dir, num_qubits, meas_qubits, device_name,
    ...
    classes_of_interest = [0, 1, 4, 8]

    mnist_test = MNIST(root = "./mnistdata_test1", train = False, download = True)
...
num_shots = 10000
best_t = 0.5
circs_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/mnist4/trained_circuit/'
num_test_samples = 4071
transpiler_opt_level = 3
results_save_dir = '/home/singhg12/isilon/Gurinder/Benchmark_medmnist/QCS_gpu_binary_scale/git/trained_models/mnist4/trained_circuit/inference_sim'
